...
# Caminho do arquivo
arquivo_excel = 'Datasets/ESFT0100_atual.xlsx'
...
df_fat = pd.read_excel(arquivo_excel, usecols=colunas_fat)
...
df_fat.to_parquet('Datasets/ESFT0100_atual.parquet', index=False)
